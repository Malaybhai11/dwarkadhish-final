    ...
    return (
        <section className="relative w-full bg-white py-24 lg:py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                {/* Header */}
                <div className="text-center max-w-3xl mx-auto mb-1 lg:mb-20">
                    <motion.div
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mb-20"
                >
                    <div className="relative w-full h-[260px] sm:h-[340px] md:h-[420px] lg:h-[500px]">
                        <img
                            src="/custom-book-img.png"
                            alt="Custom notebook process"
