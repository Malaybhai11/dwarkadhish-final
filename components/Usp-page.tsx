    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mt-8">
        ...
        <div className="relative backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-5 group/item hover:bg-white/10 transition-all duration-500">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-white/90 font-semibold text-sm">Digital Printing</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">High-speed precision with vibrant color accuracy</p>
          </div>
        </div>
        ...
        <div className="relative backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-5 group/item hover:bg-white/10 transition-all duration-500">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-white/90 font-semibold text-sm">Offset Printing</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">Large-volume excellence with consistent quality</p>
          </div>
        </div>
        ...
        <div className="relative backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-5 group/item hover:bg-white/10 transition-all duration-500">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-white/90 font-semibold text-sm">Quality Control</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">Rigorous inspection ensures zero-defect output</p>
          </div>
        </div>
        ...
        <div className="relative backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-5 group/item hover:bg-white/10 transition-all duration-500">
          ...
          <div className="absolute inset-0 opacity-20 group-hover/item:opacity-40 transition-opacity duration-500 overflow-hidden rounded-xl">
            <div className="absolute inset-0 bg-gradient-to-r from-red-500/20 via-yellow-500/20 via-green-500/20 via-blue-500/20 to-purple-500/20"
                 style={{
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-white/90 font-semibold text-sm">Color Matching</span>
            </div>
            <p className="text-slate-400 text-xs leading-relaxed">Pantone-perfect accuracy for brand consistency</p>
          </div>
        </div>
      </div>
